...
public record SavedPlaceResponse(
        ...
        @Schema(description = "경도 (좌표 정보가 없는 장소면 null)", example = "126.980470") Double longitude,
    ...
    public static SavedPlaceResponse from(SavedPlace savedPlace, boolean hasIndoorMap) {
        ...
        return new SavedPlaceResponse(
                ...
                locationPoint != null ? locationPoint.getY() : null,
                locationPoint != null ? locationPoint.getX() : null,
                null,
                hasIndoorMap,
                !place.isDeleted(),
